        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#projects" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>Roadmap</Nav.Link>
              ...
              <Nav.Link href="#buy" className={activeLink === 'buy' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('buy')}>Buy</Nav.Link>
              <Nav.Link href="/play" className={activeLink === 'play' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('play')}>Play</Nav.Link>
            </Nav>
